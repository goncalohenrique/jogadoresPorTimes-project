...
class JogadoresServicesUnitTest {
    ...
    void cadastrar_jogadorCaso1() {
        ...
        Jogador jogadorCadTeste = new Jogador(new JogadorRequestDTO(900, "Messi", 20000000L, 1L));
        jogadorCadTeste.setIdJogador(1L);
        when(jogadorRepository.save(any(Jogador.class))).thenReturn(jogadorCadTeste);

        Jogador jogadorSalvo = jogadoresServices.cadastrar_jogador(
                new JogadorRequestDTO(900, "Messi", 20000000L, 1L)
        );
